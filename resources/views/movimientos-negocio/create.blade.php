                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="area" class="form-select @error('area') is-invalid @enderror">
                                ...
                                <option value="papeleria"   {{ old('area') == 'papeleria'   ? 'selected' : '' }}>Papelería</option>
                                <option value="impresiones" {{ old('area') == 'impresiones' ? 'selected' : '' }}>Impresiones</option>
                                <option value="compartido"  {{ old('area') == 'compartido'  ? 'selected' : '' }}>Compartido</option>
                            </select>
